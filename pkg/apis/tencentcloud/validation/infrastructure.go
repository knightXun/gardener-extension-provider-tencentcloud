...
func ValidateInfrastructureConfig(infra *apistencentcloud.InfrastructureConfig, nodesCIDR, podsCIDR, servicesCIDR *string) field.ErrorList {
...
func ValidateInfrastructureConfigUpdate(oldConfig, newConfig *apistencentcloud.InfrastructureConfig) field.ErrorList {
	allErrs := field.ErrorList{}
