...
const (
	...
	// StorageProviderName is the name of the tencent storage provider.
	StorageProviderName = "COS"

	// InfraRelease is the name of the tencentcloud-infra chart.
	InfraRelease = "tencentcloud-infra"

	// MachineControllerManagerImageName is the name of the MachineControllerManager image.
	MachineControllerManagerImageName = "machine-controller-manager"
	// CloudControllerManagerImageName is the name of the CloudControllerManager image.
	CloudControllerManagerImageName = "tencentcloud-controller-manager"
	...
	CSIPluginImageName = "csi-plugin-tencentcloud"
